	...
	public static void main(String[] args) {
		...
		do {
			...
			case "05":
				...
				System.out.println("\t Sistema de aluguel de Condomínio, neste sistema você\n "
						+ "\t será capaz cadastrar um usuário no sistema, logo após no\n"
						+ "\t o cadastro será possível a reserva de uma casas\n"
						+ "\t condomínio.");
				System.out.println("");
				System.out.println("");
				input.nextLine();
